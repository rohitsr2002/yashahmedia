          ...
          <div className="breadcrumb-wapper style-2">
            <div className="breadcrumb-title-box">
              <h1 className="breadcrumb-title ak-w-70">
                <span className="highlight-text">Get In Touch</span> With our Digital
                <span className="highlight-text">Professional Team</span>
              </h1>
              <div className="breadcrumb-caption">
                ...
                <span className='text-white'><a href="/">Home</a> / Contact Us </span>
              </div>
            </div>
          </div>
        </div>
        <div className="breadcrumb-stroke text-normal">CONTACT</div>
      </div>
              ...
              <div className="ak-center">
                <div className="contact-form-box">
                  <div className="contact-form-wapper style-2">
                    <h5 className="contact-title text-center">Send a Message</h5>
                    <div className="ak-height-30 ak-height-lg-30"></div>
                    <form>
                      <div className="row g-4">
                        <div className="col-md-6">
                          <input type="text" className="input-text style-2" placeholder="First name" aria-label="First name" name="firstName" required />
                        </div>
                        <div className="col-md-6">
                          <input type="text" className="input-text style-2" placeholder="Last name" name="lastName" aria-label="Last name" required />
                        </div>
                        <div className="col-md-6">
                          <input type="email" className="input-text style-2" placeholder="Email" aria-label="Email" name="email" required />
                        </div>
                        <div className="col-md-6">
                          <input type="text" className="input-text style-2" placeholder="Phone" name="Phone" aria-label="Phone" required />
                        </div>
                        <div className="col-md-12">
                          <input type="text" className="input-text style-2" placeholder="Subject" name="subject" aria-label="Subject" required />
                        </div>
                        <div className="col-md-12">
                          <textarea name="massage" className="textarea-text style-2" rows="5" placeholder="Your Message..."></textarea>
                        </div>
                      </div>
        ...
        <div className="ak-center">
          <div className="contact-cards">
            <div className="contact-card">
              ...
              <p className="contact-text" style={{ padding: 20 }}>
