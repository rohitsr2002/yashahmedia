  ...
  useEffect(() => {
    ...
    const handlePortfolioClick = (e) => {
      if (e.target.classList.contains('portfolio-btn')) {
        ...
        if (websiteUrl === "#" || !websiteUrl || websiteUrl.startsWith("SOFTWARE_WEBSITE_URL")) {
          e.preventDefault();
          const dataWebsite = e.target.getAttribute('data-website');
          if (dataWebsite && dataWebsite !== "#" && !dataWebsite.startsWith("SOFTWARE_WEBSITE_URL")) {
          ...
          <div className="breadcrumb-wapper style-2">
            <div className="breadcrumb-title-box">
              <h1 className="breadcrumb-title ak-w-70">
                Our <span className="highlight-text">Software</span> Success Stories & 
              ...
              <div className="breadcrumb-caption">
                ...
                <span><a href="index.html">Home</a> / Software Portfolio </span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="ak-center">
                <div className="contact-form-box">
                  <div className="contact-form-wapper style-2">
                    <h5 className="contact-title text-center">10+Software Projects Delivered Successfully</h5>
                      ...
                      <div className="portfolio-grid">
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Software 1</span>
                          </div>
                          <h3 className="portfolio-title">Software Project 1</h3>
                          <p className="portfolio-category">CRM Solution</p>
                          <a href="https://k010.in/login" className="portfolio-btn" data-website="SOFTWARE_WEBSITE_URL_1">
                            Visit Website
                          </a>
                        </div>
                        {/* Card 2 */}
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/software2.png" 
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Software 2</span>
                          </div>
                          <h3 className="portfolio-title">Software Project 2</h3>
                          <p className="portfolio-category">Inventory Management</p>
                          <a href="#" className="portfolio-btn" data-website="SOFTWARE_WEBSITE_URL_2">
                            Visit Website
                          </a>
                        </div>
                        {/* Card 3 */}
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/software3.png" 
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Software 3</span>
                          </div>
                          <h3 className="portfolio-title">Software Project 3</h3>
                          <p className="portfolio-category">HRMS Platform</p>
                          <a href="#" className="portfolio-btn" data-website="SOFTWARE_WEBSITE_URL_3">
                            Visit Website
                          </a>
                        </div>
                      </div>
          ...
          <div className="ak-video-popup-container">
            <div className="ak-video-popup-align">
              <div className="embed-responsive embed-responsive-16by9">
                <iframe className="embed-responsive-item" src="./assets/about:blank" title="Video"></iframe>
              </div>
            </div>
