...
const Clients = () => {
  ...
  // Generate client cards (1-136)
  const generateClientCards = () => {
    const cards = [];
    for (let i = 1; i <= 136; i++) {
      cards.push(
        <div className="client-card" key={i}>
          <img src={`./assets/logos/${i}.jpg`} alt={`Client ${i}`} />
        </div>
      );
    }
    return cards;
          ...
          <div className="breadcrumb-wapper style-2">
            <div className="breadcrumb-title-box">
              <h1 className="breadcrumb-title ak-w-70">
                <span className="highlight-text">Our Trusted</span> Digital
                <span className="highlight-text">Partnership Network</span>
              </h1>
              <div className="breadcrumb-caption">
                ...
                <span><a href="index.html">Home</a> / Clients </span>
              </div>
            </div>
          </div>
        </div>
        <div className="breadcrumb-stroke text-normal">CLIENTS</div>
      </div>
      {/* End Breadcrumb */}
   
      {/* Start Top Counter Section */}
          ...
          <div className="row justify-content-center text-center">
            ...
            <div className="col-md-3 col-6 mb-4">
              <div className="counter-card">
                ...
                <div className="counter-label">Satisfaction Rate</div>
              </div>
            </div>
            <div className="col-md-3 col-6 mb-4">
              <div className="counter-card">
