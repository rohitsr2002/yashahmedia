  ...
  useEffect(() => {
    ...
    const handlePortfolioClick = (e) => {
      if (e.target.classList.contains('portfolio-btn')) {
        const websiteUrl = e.target.getAttribute('href');
        // Only prevent default and handle if href is "#" or placeholder
        if (websiteUrl === "#" || !websiteUrl || websiteUrl.startsWith("CLIENT_WEBSITE_URL")) {
          e.preventDefault();
          const dataWebsite = e.target.getAttribute('data-website');
          if (dataWebsite && dataWebsite !== "#" && !dataWebsite.startsWith("CLIENT_WEBSITE_URL")) {
            window.open(dataWebsite, '_blank');
          }
        } else {
          // Always open in new tab for real links
          e.preventDefault();
        ...
        <div className="offcanvas-body">
          <div className="offcanvas-body-coustom-style">
            <div className="offcanvas-logo-content">
              <a className="ak-site_branding dark-logo" href="#">
                <img src="./assets/assets/img/logo/dark-logo.svg" alt="..." />
              </a>
              <a className="ak-site_branding white-logo" href="index.html">
                <img src="./assets/assets/img/logo/dark-logo.png" alt="..." />
              </a>
            </div>
            <p className="desp">
            ...
            <div className="row row-cols-3 g-3">
              <div className="col">
                <img src="./assets/assets/img/gallery/mini-gallery-1.png" className="img-fluid" alt="..." />
              </div>
              <div className="col">
                <img src="./assets/assets/img/gallery/mini-gallery-2.png" className="img-fluid" alt="..." />
              </div>
              <div className="col">
                <img src="./assets/assets/img/gallery/mini-gallery-3.png" className="img-fluid" alt="..." />
              </div>
              <div className="col">
                <img src="./assets/assets/img/gallery/mini-gallery-4.png" className="img-fluid" alt="..." />
              </div>
              <div className="col">
                <img src="./assets/assets/img/gallery/mini-gallery-5.png" className="img-fluid" alt="..." />
              </div>
              <div className="col">
                <img src="./assets/assets/img/gallery/mini-gallery-6.png" className="img-fluid" alt="..." />
              </div>
            </div>

            <div className="offcanvas-footer-contant">
              <p className="short-title">Yashah Media</p>
              <a className="email" href="mailto:info@yashahmedia.com">info@yashahmedia.com</a>
              <a className="email" href="tel:+91 8285435377">01245181301</a>
              <a href="#" style={{ padding: 20 }} className="address">
          ...
          <div className="breadcrumb-wapper style-2">
            <div className="breadcrumb-title-box">
              <h1 className="breadcrumb-title ak-w-70">
                Our <span className="highlight-text">E-Commerce</span> Success Stories & 
                <span className="highlight-text">Digital Transformations</span>
              </h1>
              <div className="breadcrumb-caption">
                ...
                <span><a href="index.html">Home</a> / E-Commerce Portfolio </span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="ak-center">
                <div className="contact-form-box">
                  <div className="contact-form-wapper style-2">
                    <h5 className="contact-title text-center">250+ E-Commerce Projects Delivered Successfully</h5>
                      ...
                      <div className="portfolio-grid">
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Pizza Project</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 1</h3>
                          <p className="portfolio-category">Pizzacircle</p>
                          <a href="https://pizzacircle.in/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_1">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 2</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 2</h3>
                          <p className="portfolio-category">JBM Mart</p>
                          <a href="https://jbmmart.com/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_2">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/chicken.png" 
                              alt="E-commerce Project 3" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.onerror=null;
                                e.target.src='assets/img/portfolio/3.jpeg';
                              }} 
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 3</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 3</h3>
                          <p className="portfolio-category">Naughty chicken</p>
                          <a href="https://naughtychickken.ca/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_3">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/sleep.png" 
                              alt="E-commerce Project 4" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.onerror=null;
                                e.target.src='imges/sleep.png';
                              }} 
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 4</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 4</h3>
                          <p className="portfolio-category">Feather Sleep</p>
                          <a href="https://feathersleep.com/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_4">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/shopc.png" 
                              alt="E-commerce Project 5" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.style.display='none'; 
                                e.target.nextElementSibling.style.display='block';
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 5</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 5</h3>
                          <p className="portfolio-category"> Shop Print Culture</p>
                          <a href="https://shopprintculture.com/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_5">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/cake.png" 
                              alt="E-commerce Project 6" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.style.display='none'; 
                                e.target.nextElementSibling.style.display='block';
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 6</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 6</h3>
                          <p className="portfolio-category">Cake Mystery</p>
                          <a href="https://cakemystery.com/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_6">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/tulsi.png" 
                              alt="E-commerce Project 7" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.style.display='none'; 
                                e.target.nextElementSibling.style.display='block';
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 7</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 7</h3>
                          <p className="portfolio-category">Tulsi Ayurveda</p>
                          <a href="https://tulsiayurved.com/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_7">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/j.png" 
                              alt="E-commerce Project 8" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.style.display='none'; 
                                e.target.nextElementSibling.style.display='block';
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 8</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 8</h3>
                          <p className="portfolio-category">Jewelry Store</p>
                          <a href="https://www.tathaastujewels.com/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_8">
                            Visit Website
                          </a>
                        </div>
                        ...
                        <div className="portfolio-card">
                          <div className="portfolio-image-container">
                            <img 
                              src="./assets/imges/foocra.png" 
                              alt="E-commerce Project 9" 
                              className="portfolio-image" 
                              onError={(e) => {
                                e.target.style.display='none'; 
                                e.target.nextElementSibling.style.display='block';
                            ...
                            />
                            <span className="placeholder-text" style={{display:'none'}}>Project 9</span>
                          </div>
                          <h3 className="portfolio-title">E-commerce Project 9</h3>
                          <p className="portfolio-category">Foocra</p>
                          <a href="https://foocra.in/" className="portfolio-btn" data-website="CLIENT_WEBSITE_URL_9">
                            Visit Website
                          </a>
                        </div>
                      </div>
        ...
        <div className="ak-center">
          <div className="contact-cards">
            <div className="contact-card">
              ...
              <p className="contact-text" style={{padding:10}}>
                Unit No- 2012 DLF Corporate Green Tower A  
                Sector 74a, SPR Road, Gurgaon
              </p>
            </div>
